...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public User viewUserByEmail(String userEmail)
    {
        Optional<User> findUserByEmail=userDao.findByUserEmail(userEmail);
        if(findUserByEmail.isPresent())
        {
        ...
        {
            throw new UserIdNotFoundException(STR+userEmail+" doesnot exist so cannot show details.");
        }
    }
